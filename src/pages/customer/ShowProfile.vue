...
<template>
  <q-page class="flex">
    <div class="full-width">
      ...
      <div class="q-pa-md">
        <div class="row">
          <div class="col-12 text-body1 q-pa-xs" v-if="user.isValidated">
            <q-icon
          ...
          <div v-else class="col-12 text-body1 q-pa-xs">
            <q-icon
              name="error_outline"
              color="warning"
              style="font-size: 2em;" />
